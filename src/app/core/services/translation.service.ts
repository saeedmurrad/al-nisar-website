...
const DICTIONARY: Record<Lang, Record<DictKey, string>> = {
  ...
  ur: {
    ...
    'home.explorePrayer': 'حنفی اوقاتِ نماز، ہجری اور عیسوی تاریخ کے ساتھ — بورے والہ یا آپ کی جگہ۔',
    ...
    'prayer.calcNote':
      'اوقات حساب سے نکالے گئے ہیں (یونیورسٹی آف اسلامک سائنسز کراچی + حنفی عصر)۔ ضرورت ہو تو مقامی تصدیق کریں — مفتی ٹائم ٹیبل نہیں۔',
    'prayer.name.fajr': 'فجر',
    'prayer.name.sunrise': 'طلوعِ آفتاب',
    ...
    'irshadat.subtitle': 'صوفی نثار احمد کے ارشادات — سب کے لیے کھلے ہیں، بغیر لاگ اِن۔',
    ...
    'shajra.subtitle': 'صوفی نثار احمد کا روحانی سلسلہ — طالبانِ حق کے لیے کھلا ہے۔',
    'shajra.order': 'نمبر',
    ...
    'footer.rights': 'النثار۔ ارشادات روحانی فائدے کے لیے ہیں۔',
    'common.loading': 'لوڈ ہو رہا ہے…',
    'common.error': 'مواد لوڈ نہیں ہو سکا۔ براہ کرم انٹرنیٹ چیک کر کے دوبارہ کوشش کریں۔',
    'consent.title': 'تجزیاتی کوکیز',
    'consent.message':
      'ہم گوگل اینالیٹکس سے یہ سمجھتے ہیں کہ زائرین ویب سائٹ کیسے استعمال کرتے ہیں۔ صرف گمنام استعمال کی معلومات جمع ہوتی ہیں — آپ کا نام، پیغامات یا ذاتی مواد نہیں۔',
